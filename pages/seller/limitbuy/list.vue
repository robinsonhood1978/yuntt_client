			...
			<view class="gallery mg5">
							...
							<view class="uni-flex uni-column ml10 pb10 mr10 pt10">
								...
								<view class="uni-flex uni-row mt10 flex-middle">
									<view class="uni-flex uni-row mb10">
										<view v-if="item.promotion" class="uni-flex uni-row width-between l-h20">
											<text class="f-red uni-bold">秒杀价：{{item.promotion.price|currency}}</text>
				...
				<view class="uni-flex">
					<view class="fixed-bottom bgf">
						<navigator url="/pages/seller/limitbuy/build" class="mybutton f-white f-15 mt10 mr10 mb10 ml10"
							hover-class="none">新增秒杀活动</navigator>
					</view>
